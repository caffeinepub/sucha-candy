...
const LEVELS = Array.from({ length: 500 }, (_, i) => ({
  level: i + 1,
  targetScore: Math.round(500 * 1.035 ** i),
  moves: Math.max(10, 20 - Math.floor(i / 25)),
  goal: getLevelGoal(i)
}));
const SCORE_PER_MATCH = {
  3: 20,
  4: 50,
  5: 80
};
const SPECIAL_SCORE = 500;
const COMBO_BLAST_SCORE = 100;
const SPECIAL_OVERLAY = {
  "striped-h": "≡",
  "striped-v": "|||",
  bomb: "💥",
  colorbomb: "🌈"
};
const CandyCell = ({ cell, onClick }) => {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: cell.isSelected ? `0 0 20px ${baseColor}, 0 4px 8px rgba(0,0,0,0.4)` : "0 4px 8px rgba(0,0,0,0.3), inset 0 1px 1px rgba(255,255,255,0.3)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl drop-shadow-sm", children: cell.isEmpty ? "" : CANDY_EMOJI[cell.type] }),
            cell.special !== "none" && !cell.isEmpty && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 flex items-center justify-center text-sm font-bold text-white opacity-80", children: SPECIAL_OVERLAY[cell.special] })
          ]
        }
      )
    }
...
const GameBoard = ({ board, onCellClick }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        background: "linear-gradient(135deg, rgba(120,40,200,0.8) 0%, rgba(60,10,120,0.9) 100%)",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: board.map(
            (row, r) => row.map((cell, c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              CandyCell,
              {
                cell,
                row: r,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-black text-red-400 mb-2", children: "Game Over!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 mb-4", children: "You ran out of moves" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white mb-1", children: [
              "Score:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-400 font-bold", children: score.toLocaleString() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/60 mb-6", children: [
              "Target was: ",
              target.toLocaleString()
            ] }),
            !bonusChanceUsed && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
...
const CANDY_EMOJIS$1 = ["🍒", "🍇", "🍓", "🍎", "🥭", "🍑"];
const HomeScreen = ({ onStart }) => {
  const [candies, setCandies] = reactExports.useState([]);
  reactExports.useEffect(() => {
    const generated = Array.from({ length: 20 }, (_, i) => ({
      id: i,
      emoji: CANDY_EMOJIS$1[Math.floor(Math.random() * CANDY_EMOJIS$1.length)],
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        ...
        position: "relative",
        overflow: "hidden",
        background: "radial-gradient(ellipse at 50% 0%, #3d0066 0%, #1a0033 40%, #0d001a 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        candies.map((candy) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              height: "250px",
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(255,80,150,0.12) 0%, transparent 70%)",
              pointerEvents: "none"
            }
          }
        ),
            ...
            children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    style: {
                      ...
                      lineHeight: 1.05,
                      margin: 0,
                      background: "linear-gradient(135deg, #ff88cc 0%, #ffd700 40%, #ff88cc 80%, #cc44ff 100%)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Match 3 or more to score!"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    borderRadius: "100px",
                    cursor: "pointer",
                    background: "linear-gradient(135deg, #ff4499 0%, #ff8c00 50%, #ffd700 100%)",
                    color: "#1a0033",
                    boxShadow: "0 0 30px rgba(255,100,150,0.5), 0 0 60px rgba(255,180,0,0.3), inset 0 1px 1px rgba(255,255,255,0.3)",
                    textTransform: "uppercase",
                    transition: "transform 0.15s ease, box-shadow 0.15s ease"
                  },
                  onMouseEnter: (e) => {
                    e.currentTarget.style.transform = "scale(1.06) translateY(-2px)";
                    e.currentTarget.style.boxShadow = "0 0 50px rgba(255,100,150,0.7), 0 0 80px rgba(255,180,0,0.4), inset 0 1px 1px rgba(255,255,255,0.3)";
                  },
                  onMouseLeave: (e) => {
                    e.currentTarget.style.transform = "scale(1) translateY(0)";
                    e.currentTarget.style.boxShadow = "0 0 30px rgba(255,100,150,0.5), 0 0 60px rgba(255,180,0,0.3), inset 0 1px 1px rgba(255,255,255,0.3)";
                  },
                  children: "🎮 Play Now"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "500 levels of sweet chaos"
                }
              )
            ]
          }
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                children: isWin ? "You Win!" : "Level Complete!"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 mb-4", children: isWin ? "Congratulations, candy master!" : `Level ${level + 1} cleared!` }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white mb-6", children: [
              "Score:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-400 font-bold", children: score.toLocaleString() })
            ] }),
            !isWin && level < LEVELS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/60 mb-4", children: [
              "Next target:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-300", children: LEVELS[level + 1].targetScore.toLocaleString() })
            ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "80px" } })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["score", "collect", "special"].map((g) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                style: {
                  display: "flex",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: GOAL_ICON[g] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: GOAL_COLOR[g], fontWeight: 700 }, children: GOAL_LABEL[g] })
                ]
              },
              g
            ))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: "100%", maxWidth: "600px", marginBottom: "1.2rem" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  Math.round((unlockedUpTo + 1) / totalLevels * 100),
                  "%"
                ] })
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: levelsOnPage.map((levelIdx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: {
                    position: "relative",
                    aspectRatio: "1",
                    border: isCurrent ? "2px solid #ffd700" : isUnlocked ? `1px solid ${goalColor}44` : "1px solid rgba(255,255,255,0.06)",
                    borderRadius: "14px",
                    background: isCurrent ? "linear-gradient(135deg, rgba(255,180,0,0.3), rgba(255,80,150,0.3))" : isUnlocked ? `${goalColor}12` : "rgba(255,255,255,0.03)",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.1rem", lineHeight: 1 }, children: isUnlocked ? candy : "🔒" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    background: activePage === 0 ? "rgba(255,255,255,0.04)" : "rgba(255,255,255,0.1)",
                    border: "1px solid rgba(255,255,255,0.12)",
                    borderRadius: "100px",
                    padding: "0.4rem 1rem",
                    color: activePage === 0 ? "rgba(255,255,255,0.2)" : "rgba(255,220,255,0.8)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    background: activePage === totalPages - 1 ? "rgba(255,255,255,0.04)" : "rgba(255,255,255,0.1)",
                    border: "1px solid rgba(255,255,255,0.12)",
                    borderRadius: "100px",
                    padding: "0.4rem 1rem",
                    color: activePage === totalPages - 1 ? "rgba(255,255,255,0.2)" : "rgba(255,220,255,0.8)",
...
const ScorePanel = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "score.panel", className: "w-full flex flex-col gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Level", value: `${level + 1}`, color: "#bb44ff" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          label: "Moves",
      ...
      combo > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Combo", value: `x${combo}`, color: "#ff8c00", pulse: true })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    goal.type !== "score" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
...
const StatCard = ({ label, value, color, pulse }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "div",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-bold", style: { color }, children: value })
    ]
  }
);
let nextId = 1;
...
function findMatches(board) {
  ...
  for (let r = 0; r < BOARD_SIZE; r++) {
    ...
    while (c < BOARD_SIZE) {
      let len = 1;
      while (c + len < BOARD_SIZE && board[r][c + len].type === board[r][c].type && !board[r][c].isEmpty)
        len++;
      if (len >= 3)
        groups.push({
  ...
  for (let c = 0; c < BOARD_SIZE; c++) {
    ...
    while (r < BOARD_SIZE) {
      let len = 1;
      while (r + len < BOARD_SIZE && board[r + len][c].type === board[r][c].type && !board[r][c].isEmpty)
        len++;
      if (len >= 3)
        groups.push({
          cells: Array.from({ length: len }, (_, i) => ({
...
function applyMatches(board, combo) {
  ...
  const newSpecialPositions = /* @__PURE__ */ new Set();
  for (const group of groups) {
    ...
    if (len === 4) {
      ...
      const special = group.orientation === "horizontal" ? "striped-h" : "striped-v";
...
function applySpecialCombo(board, posA, posB) {
  ...
  const isStripedA = cellA.special === "striped-h" || cellA.special === "striped-v";
  const isStripedB = cellB.special === "striped-h" || cellB.special === "striped-v";
  let colorBombPos = null;
  let stripedPos = null;
  ...
  if (colorBombPos !== null && stripedPos !== null) {
    ...
    const toBlast = /* @__PURE__ */ new Set();
    for (let r = 0; r < BOARD_SIZE; r++)
      for (let c = 0; c < BOARD_SIZE; c++) {
  ...
  switch (action.type) {
    case "SELECT_CELL": {
      ...
      if (!state.selectedCell) {
        const board2 = cloneBoard(state.board);
        board2[pos.row][pos.col].isSelected = true;
        return { ...state, selectedCell: pos, board: board2 };
      }
      if (state.selectedCell.row === pos.row && state.selectedCell.col === pos.col) {
        const board2 = cloneBoard(state.board);
        board2[pos.row][pos.col].isSelected = false;
        return { ...state, selectedCell: null, board: board2 };
      }
    ...
    case "DECREMENT_MOVES": {
      ...
      if (newMoves <= 0 && state.phase !== "levelcomplete" && state.phase !== "win") {
...
function useGameState() {
  const [state, dispatch] = reactExports.useReducer(reducer, void 0, () => initState(0));
  const processCascade = reactExports.useCallback(
    async (initialBoard, currentLevel) => {
  ...
  const selectCell = reactExports.useCallback(
    async (pos) => {
  ...
  const checkGameOver = reactExports.useCallback(() => {
    if (state.phase === "playing" && state.moves <= 0) {
      dispatch({ type: "SET_PHASE", phase: "gameover" });
    }
  }, [state.phase, state.moves]);
  const nextLevel = reactExports.useCallback(() => dispatch({ type: "NEXT_LEVEL" }), []);
  const restart = reactExports.useCallback(() => dispatch({ type: "RESTART" }), []);
  const useBonusChance = reactExports.useCallback(
...
function App() {
  ...
  if (screen === "home")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(HomeScreen, { onStart: () => setScreen("levelselect") });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "linear-gradient(160deg, #0d001a 0%, #1a0033 50%, #0d001a 100%)",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full mb-4", style: { maxWidth: "min(90vw, 520px)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ScorePanel,
          {
            score: state.score,
            moves: state.moves,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GameBoard, { board: state.board, onCellClick: selectCell }),
          ...
          (state.phase === "levelcomplete" || state.phase === "win") && /* @__PURE__ */ jsxRuntimeExports.jsx(
            LevelCompleteScreen,
            {
              score: state.score,
              level: state.level,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 text-center text-white/30 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Click a candy, then click adjacent candy to swap" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1", children: "Match 4+ for special candies ✨" })
        ] })
      ]
    }
  );
