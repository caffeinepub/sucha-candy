              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: {
                    position: "relative",
                    aspectRatio: "1",
                    border: isCurrent ? "2px solid #ffd700" : isUnlocked ? "1px solid rgba(255,150,200,0.3)" : "1px solid rgba(255,255,255,0.06)",
                    borderRadius: "14px",
                    background: isCurrent ? "linear-gradient(135deg, rgba(255,180,0,0.3), rgba(255,80,150,0.3))" : isUnlocked ? "rgba(255,255,255,0.07)" : "rgba(255,255,255,0.03)",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.2rem", lineHeight: 1 }, children: isUnlocked ? candy : "🔒" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: {
...
const ScorePanel = ({ score, moves, level, combo }) => {
  const cfg = LEVELS[level];
  const progress = Math.min(100, score / cfg.targetScore * 100);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "score.panel", className: "w-full flex flex-col gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-4 rounded-full bg-white/10 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
